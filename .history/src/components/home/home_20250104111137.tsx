...
<<<<<<< HEAD
    const sentences = ["CodeBuzz is the best platform to help you enhance your skills, expand your knowledge and prepare for technical interviews.", "Explore is a well-organized tool that helps you get the most out of CodeBuzz by providing structure to guide your progress towards the next step in your programming career."]
=======
...
>>>>>>> 9ff0339d33b2d540b4d61e8e479667eddaf61267
            ...
            <section className="text-white body-font">
                <div className="container px-5 py-24 mx-auto">
                    <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
                        ...
                        <h2 className="text-gray-900 font-medium title-font tracking-wider text-base">Team</h2>
                        <p className="text-gray-500">CodeBuzz</p>
                    </div>
                </div>
            </section>
        </div>
